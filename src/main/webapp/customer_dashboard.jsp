...
<script src="https://cdnjs.cloudflare.com/ajax/libs/html2pdf.js/0.9.3/html2pdf.bundle.min.js"></script>
 ...
 <style>
        body {
            ...
            background: linear-gradient(120deg, #f6d365, #fda085, #f6d365, #fda085); /* Vibrant gradient background */
        ...
        /* Modal styling */
        #addMoneyModal, #removeMoneyModal {
            display: none;
            position: fixed;
            z-index: 1;
            left: 0;
        ...
        #addMoneyModal div, #removeMoneyModal div {
...
<div class = "container"> 
    ...
    <button onclick="openAddMoneyAlert()">Deposit</button>
    <button onclick="openRemoveMoneyAlert()">Withdraw</button>
