...
<%
    ...
    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/bank", "root", "Dinesh503#");
...
<form action="update_process.jsp" method="post" onsubmit="return validateForm()">
    ...
    <input type="text" id="date_of_birth" name="date_of_birth" value="<%= rs.getString("date_of_birth") %>" /><br />
