...
<body>
    ...
    <div style="display: flex; flex-direction: row; justify-content: space-between; margin: 2px 85px">
        <h2 style="margin-left: 10rem; margin-top: 2rem;">Startup Bank</h2>
    ...
    <table border="1">
        ...
        <%
            try {
                ...
                ResultSet rs = stmt.executeQuery("SELECT account_no, full_name, address, mobile_no, email, account_type, date_of_birth, id_proof FROM customer");
